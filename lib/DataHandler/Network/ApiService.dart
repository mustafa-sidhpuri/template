...
import '../Local/PrefKeys.dart';
import '../../Constants/TimeDurations.dart';
import '../../Utils/Utils.dart';
import '../Local/SharedPrefs.dart';
import 'Utils/BaseException.dart';
import 'Utils/ErrorCodes.dart';
import 'Utils/ErrorParsingModel.dart';
...
class ApiService {
  ...
  static Future<void> postRequest({
    ...
    try {
      ...
      onError = await getError(dioError: dioError,networkError: onError);
